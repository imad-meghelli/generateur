...
(function() {
  ...
  results_tmpl = '{{#results}}\n<table class="result">\n   <tr>\n    <td>score: </td>\n    <td>{{score}} / 4</td>\n   <tr>\n    <td colspan="3">tentatives:</td>\n  </tr>\n  {{& guess_times_display}}\n  {{& feedback_display }}\n  <tr>\n    <td colspan="3"><strong>détections:</strong></td>\n  </tr>\n</table>\n{{& sequence_display}}\n{{/results}}';

  guess_times_tmpl = '<tr>\n  <td>100 / heure:</td>\n  <td>{{online_throttling_100_per_hour}}</td>\n  <td> &nbsp;&nbsp;(attaque en-ligne limitée)</td>\n</tr>\n<tr>\n  <td>10&nbsp; / seconde:</td>\n  <td>{{online_no_throttling_10_per_second}}</td>\n  <td> &nbsp;&nbsp;(attaque en-ligne non-limitée)</td>\n</tr>\n<tr>\n  <td>10 000 / seconde:</td>\n  <td>{{offline_slow_hashing_1e4_per_second}}</td>\n  <td> &nbsp;&nbsp;(attaque hors-ligne, avec fontion de hachage lente, multi-coeurs)</td>\n<tr>\n  <td>1 000 000 000 / seconde:&nbsp;&nbsp;</td>\n  <td>{{offline_fast_hashing_1e10_per_second}}</td>\n  <td> &nbsp;&nbsp;(attaque hors-ligne, avec fontion de hachage rapide, multi-coeurs)</td>\n</tr>';

  feedback_tmpl = '{{#warning}}\n<tr>\n  <td>avertissement: </td>\n  <td colspan="2">{{warning}}</td>\n</tr>\n{{/warning}}\n{{#has_suggestions}}\n<tr>\n  <td style="vertical-align: top">suggestions:</td>\n  <td colspan="2">\n    {{#suggestions}}\n    - {{.}} <br />\n    {{/suggestions}}\n  </td>\n</tr>\n{{/has_suggestions}}';

  props_tmpl = '<div class="match-sequence">\n{{#sequence}}\n<table>\n  <tr>\n    <td colspan="2">\'{{token}}\'</td>\n  </tr>\n  <tr>\n    <td>modèle:</td>\n    <td>{{pattern}}</td>\n  </tr>\n  <tr>\n   </tr>\n  {{#cardinality}}\n  <tr>\n    <td>cardinalité:</td>\n    <td>{{cardinality}}</td>\n  </tr>\n  <tr>\n    <td>taille:</td>\n    <td>{{length}}</td>\n  </tr>\n  {{/cardinality}}\n  {{#rank}}\n  <tr>\n    <td>nom_dictionnaire:</td>\n    <td>{{dictionary_name}}</td>\n  </tr>\n  <tr>\n    <td>rang:</td>\n    <td>{{rank}}</td>\n  </tr>\n  <tr>\n    <td>inversé:</td>\n    <td>{{reversed}}</td>\n  </tr>\n  {{#l33t}}\n  <tr>\n    <td>remplacements l33t:</td>\n    <td>{{sub_display}}</td>\n  </tr>\n  <tr>\n    <td>dél33té:</td>\n    <td>{{matched_word}}</td>\n  </tr>\n  {{/l33t}}\n  <tr>\n   </tr>\n  <tr>\n    <td>variations-majuscules:</td>\n    <td>{{uppercase_variations}}</td>\n  </tr>\n  <tr>\n    <td>variations-l33t:</td>\n    <td>{{l33t_variations}}</td>\n  </tr>\n  {{/rank}}\n  {{#graph}}\n  <tr>\n    <td>graphe:</td>\n    <td>{{graph}}</td>\n  </tr>\n  <tr>\n    <td>tours:</td>\n    <td>{{turns}}</td>\n  </tr>\n  <tr>\n   {{/graph}}\n  {{#base_token}}\n   <tr>\n    <td>nombre_de_repetitions:</td>\n    <td>{{repeat_count}}</td>\n  </tr>\n  {{/base_token}}\n  {{#sequence_name}}\n  <tr>\n    <td>nom_de_sequence:</td>\n    <td>{{sequence_name}}</td>\n  </tr>\n  <tr>\n    <td>taille_de_sequence</td>\n    <td>{{sequence_space}}</td>\n  </tr>\n  <tr>\n    <td>ordre_croissant:</td>\n    <td>{{ascending}}</td>\n  </tr>\n  {{/sequence_name}}\n  {{#regex_name}}\n  <tr>\n    <td>nom_regex:</td>\n    <td>{{regex_name}}</td>\n  </tr>\n  {{/regex_name}}\n  {{#day}}\n  <tr>\n    <td>jour:</td>\n    <td>{{day}}</td>\n  </tr>\n  <tr>\n    <td>mois:</td>\n    <td>{{month}}</td>\n  </tr>\n  <tr>\n    <td>année:</td>\n    <td>{{year}}</td>\n  </tr>\n  <tr>\n    <td>séparateur:</td>\n    <td>\'{{separator}}\'</td>\n  </tr>\n  {{/day}}\n</table>\n{{/sequence}}\n</div>';
